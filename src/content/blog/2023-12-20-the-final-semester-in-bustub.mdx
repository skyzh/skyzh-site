...
So far, I have described how we designed the point distribution to make the first 80 points easy to earn and the remaining points difficult. I also employed several methods to balance the difficulty of each part of the project.
...
As part of my optimizer research with Andy, I studied several optimizer frameworks. Apache Calcite is the one that particularly interests me, and I tried building something on top of it.
