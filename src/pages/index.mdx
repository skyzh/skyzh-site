...
A: In English, *Chi* is usually pronounced /tʃiː/ (like "chi" in "cheese" without the "se"). You can find the Mandarin pronunciation in [this video](https://www.youtube.com/watch?v=xTU2n22G6kc) (2nd tone). *Zhang* is often pronounced like "John."
...
A: My database journey began in 2020 when I submitted my first patch to TiKV as part of the LFX Mentorship project (similar to GSoC). Since then, I've focused on databases and storage systems. I also have a course on building a storage engine from scratch: check out [mini-lsm](https://github.com/skyzh/mini-lsm).
