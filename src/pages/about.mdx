...
<Layout
	...
	updatedDate={new Date('2025-05-25T17:00:00-05:00')}
	slug="page-about"
>

I earned my bachelor’s degree in computer science from [Shanghai Jiao Tong University][sjtu] and a master’s degree from [Carnegie Mellon University][cmu]. Currently, I am a Systems Software Engineer at [Neon][neon] (acquired by Databricks).
