...
在数据库系统中，我们可以通过创建索引的方式来加速 Join 计算的性能。比如 Postgres 就支持 [Index Scans](https://www.postgresql.org/docs/current/indexes-index-only-scans.html)，通过扫描索引来加快 Join 的速度。然而，“索引”在流处理系统中很难实现。原因有二：
